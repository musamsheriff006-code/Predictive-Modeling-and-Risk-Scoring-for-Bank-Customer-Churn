...
region = st.sidebar.selectbox("Region",["France","Germany","Spain","India","Australia"])
...
new_balance = st.slider("Adjust Balance",0,250000,balance)
new_products = st.slider("Adjust Products",1,4,products)
new_active = st.selectbox("Adjust Activity",[0,1], index=active_member)
